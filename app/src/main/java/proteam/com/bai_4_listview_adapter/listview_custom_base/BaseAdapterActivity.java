...
public class BaseAdapterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLvMain.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(BaseAdapterActivity.this, user.getTitle() + "--" + user.getContent(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        mLvMain.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                Toast.makeText(BaseAdapterActivity.this, "Scroll", Toast.LENGTH_LONG).show();
            }
        ...
        ((Button) findViewById(R.id.btnAdd)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mEdTitle.getText().toString().equals("")||mEdContent.getText().toString().equals("")){
                    Toast.makeText(BaseAdapterActivity.this, "Please input valid data!!", Toast.LENGTH_SHORT).show();
                    return;
                }else {
    ...
    private void showAlertDialog(final int position) {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(BaseAdapterActivity.this);
